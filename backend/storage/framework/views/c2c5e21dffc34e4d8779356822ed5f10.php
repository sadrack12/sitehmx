        ...
        <div class="header-modern">
            ...
            <?php if($configuracao): ?>
                <?php if($configuracao->a_republica): ?>
                    <div class="governo-info" style="display: block; color: #000000; font-weight: bold; font-size: 8px; text-transform: uppercase; letter-spacing: 0.2px;"><?php echo e($configuracao->a_republica); ?></div>
                <?php endif; ?>
                <?php if($configuracao->o_ministerio): ?>
                    <div class="governo-info" style="display: block; color: #000000; font-weight: bold; font-size: 8px; text-transform: uppercase; letter-spacing: 0.2px;"><?php echo e($configuracao->o_ministerio); ?></div>
                <?php endif; ?>
                <?php if($configuracao->o_governo): ?>
                    <div class="governo-info" style="display: block; color: #000000; font-weight: bold; font-size: 8px; text-transform: uppercase; letter-spacing: 0.2px;"><?php echo e($configuracao->o_governo); ?></div>
                <?php endif; ?>
                
                <div class="instituicao-nome" style="display: block; color: #000000;"><?php echo e($configuracao->nome_instituicao); ?></div>
            <?php else: ?>
        ...
        <div class="recibo-number-modern">
            <div class="recibo-header-row">
                ...
                <div class="numero-destaque">
                    <div class="numero">Nº <?php echo e(str_pad($consulta->id, 6, '0', STR_PAD_LEFT)); ?></div>
                    <div class="data">Emitido em: <?php echo e($data_emissao); ?></div>
                </div>
            </div>
            <div class="status-inline">
                <span class="badge-modern badge-<?php echo e($consulta->status); ?>">
                    <?php echo e(ucfirst($consulta->status)); ?>

                </span>
                <?php if($consulta->agendada_online): ?>
        ...
        <div class="info-cards">
            ...
            <div class="info-card">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value-modern"><?php echo e($consulta->paciente->nome); ?></span>
                </div>
                    ...
                    <tr>
                        <td style="width: 50%; padding-right: 0.8mm; vertical-align: top;">
                            <div style="display: flex; justify-content: space-between; flex-wrap: nowrap;">
                                ...
                                <span class="info-value-modern" style="white-space: nowrap; text-align: right; flex: 1; min-width: 0;"><?php echo e($consulta->paciente->nif); ?></span>
                            </div>
                        </td>
                        <?php if($consulta->paciente->telefone): ?>
                        <td style="width: 50%; padding-left: 0.8mm; vertical-align: top;">
                            <div style="display: flex; justify-content: space-between; flex-wrap: nowrap;">
                                ...
                                <span class="info-value-modern" style="white-space: nowrap; text-align: right; flex: 1; min-width: 0;"><?php echo e($consulta->paciente->telefone); ?></span>
                            </div>
                        </td>
                        <?php else: ?>
            ...
            <div class="info-card">
                        ...
                        <tr>
                            <td style="width: 45%; padding-right: 0.8mm; vertical-align: top; word-wrap: break-word; overflow-wrap: break-word;">
                                <div style="display: flex; justify-content: space-between; flex-wrap: nowrap;">
                                    ...
                                    <span class="info-value-modern" style="white-space: nowrap; text-align: right; flex: 1; min-width: 0;">
                                        <?php echo e(\Carbon\Carbon::parse($consulta->data_consulta)->locale('pt')->isoFormat('dddd, DD/MM/YYYY')); ?>

                                    </span>
                                </div>
                            </td>
                            <?php if($consulta->hora_consulta): ?>
                            <td style="width: 20%; padding: 0 0.8mm; vertical-align: top;">
                                <div style="display: flex; justify-content: space-between; flex-wrap: nowrap;">
                                    ...
                                    <span class="info-value-modern" style="white-space: nowrap; text-align: right;"><?php echo e(\Carbon\Carbon::parse($consulta->hora_consulta)->format('H:i')); ?></span>
                                </div>
                            </td>
                            <?php else: ?>
                            <td style="width: 20%;"></td>
                            <?php endif; ?>
                            <?php if($consulta->sala): ?>
                            <td style="width: 35%; padding-left: 0.8mm; vertical-align: top; word-wrap: break-word; overflow-wrap: break-word;">
                                <div style="display: flex; justify-content: space-between; flex-wrap: nowrap;">
                                    ...
                                    <span class="info-value-modern" style="white-space: nowrap; text-align: right; flex: 1; min-width: 0;"><?php echo e($consulta->sala->nome); ?></span>
                                </div>
                            </td>
                            <?php else: ?>
                ...
                <div class="info-item">
                    ...
                    <span class="info-value-modern">
                        <?php echo e($consulta->medico->nome); ?>

                        <?php if($consulta->medico->especialidade): ?> - <?php echo e($consulta->medico->especialidade); ?><?php endif; ?>
                    </span>
                </div>
                <?php endif; ?>
            </div>
...
<?php /**PATH /var/www/html/resources/views/recibos/consulta.blade.php ENDPATH**/ ?>